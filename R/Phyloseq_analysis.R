###Effect of plate distance in diversity of samples
library(phyloseq)
library(microbiome)
library(tidyverse)
library(data.table)
...
rm(PS1, PS2, alphaDiv.PS, ord.bray, betadiv.PS, betadiv.PS.label, 
   dis.bray.1, dis.bray.2, sdat.1, sdat.2, sdatPos.1, sdatPos.2, 
   XposDist.1, XposDist.2, YposDist.1, YposDist.2, CombiDist.1,
   CombiDist.2, CombiDist)